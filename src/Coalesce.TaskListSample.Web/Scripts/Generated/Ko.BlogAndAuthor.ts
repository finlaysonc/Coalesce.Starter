...
// Knockout View Model for: BlogAndAuthor
// Auto Generated by IntelliTect.Coalesce

module ViewModels {

	export class BlogAndAuthor extends Coalesce.BaseViewModel<BlogAndAuthor>
    {
        protected modelName = "BlogAndAuthor";
        protected primaryKeyName = "blogId";
        protected modelDisplayName = "Blog And Author";

        protected apiController = "/BlogAndAuthor";
        protected viewController = "/BlogAndAuthor";
        public dataSources = ListViewModels.BlogAndAuthorDataSources;


        // The custom code to run in order to pull the initial datasource to use for the object that should be returned
        public dataSource: ListViewModels.BlogAndAuthorDataSources = ListViewModels.BlogAndAuthorDataSources.Default;

        public static coalesceConfig
            = new Coalesce.ViewModelConfiguration<BlogAndAuthor>(Coalesce.GlobalConfiguration.viewModel);
        public coalesceConfig: Coalesce.ViewModelConfiguration<BlogAndAuthor>
            = new Coalesce.ViewModelConfiguration<BlogAndAuthor>(BlogAndAuthor.coalesceConfig);
        ...
        public init(myself: BlogAndAuthor) {};
    ...
    export namespace BlogAndAuthor {
