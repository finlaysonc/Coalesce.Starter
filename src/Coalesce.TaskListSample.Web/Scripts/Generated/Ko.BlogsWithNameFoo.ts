...
// Knockout View Model for: BlogsWithNameFoo
// Auto Generated by IntelliTect.Coalesce

module ViewModels {

	export class BlogsWithNameFoo extends Coalesce.BaseViewModel<BlogsWithNameFoo>
    {
        protected modelName = "BlogsWithNameFoo";
        protected primaryKeyName = "blogId";
        protected modelDisplayName = "Blogs With Name Foo";

        protected apiController = "/BlogsWithNameFoo";
        protected viewController = "/BlogsWithNameFoo";
        public dataSources = ListViewModels.BlogsWithNameFooDataSources;


        // The custom code to run in order to pull the initial datasource to use for the object that should be returned
        public dataSource: ListViewModels.BlogsWithNameFooDataSources = ListViewModels.BlogsWithNameFooDataSources.Default;

        public static coalesceConfig
            = new Coalesce.ViewModelConfiguration<BlogsWithNameFoo>(Coalesce.GlobalConfiguration.viewModel);
        public coalesceConfig: Coalesce.ViewModelConfiguration<BlogsWithNameFoo>
            = new Coalesce.ViewModelConfiguration<BlogsWithNameFoo>(BlogsWithNameFoo.coalesceConfig);
        ...
        public init(myself: BlogsWithNameFoo) {};
    ...
    export namespace BlogsWithNameFoo {
