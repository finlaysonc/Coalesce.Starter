...
// Knockout View Model for: Author
// Auto Generated by IntelliTect.Coalesce

module ViewModels {

	export class Author extends Coalesce.BaseViewModel<Author>
    {
        protected modelName = "Author";
        protected primaryKeyName = "authorId";
        protected modelDisplayName = "Author";

        protected apiController = "/Author";
        protected viewController = "/Author";
        public dataSources = ListViewModels.AuthorDataSources;


        // The custom code to run in order to pull the initial datasource to use for the object that should be returned
        public dataSource: ListViewModels.AuthorDataSources = ListViewModels.AuthorDataSources.Default;

        public static coalesceConfig
            = new Coalesce.ViewModelConfiguration<Author>(Coalesce.GlobalConfiguration.viewModel);
        public coalesceConfig: Coalesce.ViewModelConfiguration<Author>
            = new Coalesce.ViewModelConfiguration<Author>(Author.coalesceConfig);
        ...
        constructor(newItem?: any, parent?: any){
            ...
            self.editUrl = ko.computed(function() {
                return self.coalesceConfig.baseViewUrl() + self.viewController + "/CreateEdit?id=" + self.authorId();
            });
