...
using static Coalesce.TaskListSample.Data.Models.ApplicationUser;

namespace Coalesce.TaskListSample.Web.Models
{
    public partial class ApplicationUserDtoGen : GeneratedDto<Coalesce.TaskListSample.Data.Models.ApplicationUser, ApplicationUserDtoGen>
        , IClassDto<Coalesce.TaskListSample.Data.Models.ApplicationUser, ApplicationUserDtoGen>
    {
        ...
        public static ApplicationUserDtoGen Create(Coalesce.TaskListSample.Data.Models.ApplicationUser obj, ClaimsPrincipal user = null, string includes = null,
        ...
        public ApplicationUserDtoGen CreateInstance(Coalesce.TaskListSample.Data.Models.ApplicationUser obj, ClaimsPrincipal user = null, string includes = null,
                                Dictionary<object, object> objects = null, IncludeTree tree = null)
        {
        ...
        public void Update(Coalesce.TaskListSample.Data.Models.ApplicationUser entity, ClaimsPrincipal user = null, string includes = null)
        {
            includes = includes ?? "";
